...
<!-- Vendored copy of skills/roadkeep/SKILL.md from the roadkeep repository, which is
     the source of truth. It is here because this project uses roadkeep from a sibling
     checkout (see .mcp.json) rather than through `/plugin install roadkeep@alegauss`,
     which would ship this skill itself. Re-copy it after a roadkeep upgrade. -->
